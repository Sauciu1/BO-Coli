...
class main_manager:
    ...
    def run_group_manager(self):
        ...
        # Sync all groups to manager before plotting to ensure data is up to date
        ...
        try:
            ...
            st.download_button(
                ...
                file_name=f"bo_coli_{bayes_manager.experiment_name}_{current_time}.pkl",
            ...
            st.download_button(
                ...
                file_name=f"bo_coli_{bayes_manager.experiment_name}_{current_time}.csv",
                mime="text/csv",
            )
